...
class UserForm(forms.ModelForm):
    username = forms.CharField(required=True, max_length=50,widget=forms.TextInput(attrs={'class': 'textfield form-control','placeholder': 'Username'}),validators = [validators.MinLengthValidator(1), Username_check])
